...
function MotionDemo() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      {/* Demo screen */}
      <div className="demo-screen w-full relative" style={{ minHeight: 380 }}>
        {/* Top browser bar */}
        <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5">
          ...
          <div className="flex-1 mx-3 h-6 rounded-md bg-gray-800/80 flex items-center px-3">
            <span className="text-[10px] text-gray-500 font-mono">localhost:3000/dashboard</span>
          </div>
  ...
  return (
    <div className="flex items-center justify-center p-8 h-full min-h-[320px]">
      <div className="w-full max-w-md flex flex-col gap-5">
        {/* Drop zone */}
        <div className="border-2 border-dashed border-cyan-500/40 rounded-2xl p-8 flex flex-col items-center gap-3 bg-cyan-950/10 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-cyan-500/5 to-transparent pointer-events-none" />
          <div className="w-14 h-14 rounded-2xl bg-cyan-950/60 border border-cyan-500/30 flex items-center justify-center shadow-lg shadow-cyan-500/10 animate-float">
      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.05] bg-[#020817]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-cyan-500 to-violet-600 flex items-center justify-center shadow-lg shadow-cyan-500/20 animate-float">
